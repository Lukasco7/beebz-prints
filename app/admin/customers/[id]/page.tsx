    ...
    async function loadCustomer() {
      try {
        const response = await fetch(
          `/api/get-customer?id=${customerId}`,
        );
        ...
        const loadedCustomer = data.customer as Customer;

        setCustomer(loadedCustomer);

        setFullName(loadedCustomer.full_name || "");
        setEmail(loadedCustomer.email || "");
        setPhone(loadedCustomer.phone || "");
        setWhatsapp(loadedCustomer.whatsapp || "");
        setCompanyName(loadedCustomer.company_name || "");
      } catch (err) {
        setError(
